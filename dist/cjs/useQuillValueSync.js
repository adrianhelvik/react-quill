...
var _deepEqual = _interopRequireDefault(require("./deepEqual.js"));
...
function useQuillValueSync(quill, value) {
  ...
  (0, _react.useEffect)(function () {
    if (!quill) return;
    var previous = quill.getContents();
    var current = value;

    if (!(0, _deepEqual.default)(previous, current)) {
...
var _default = useQuillValueSync;
